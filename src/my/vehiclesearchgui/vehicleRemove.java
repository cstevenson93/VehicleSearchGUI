 ...
 * @author csteve
 */
public class vehicleRemove extends javax.swing.JFrame {

    
    vehicleGUI vehicle;
    String filePath;
    
    public vehicleRemove() {
    ...
    private void initComponents() {
        ...
        removeVehicleNameButton = new javax.swing.JButton();
        tagPanel = new javax.swing.JPanel();
        tagText = new javax.swing.JLabel();
        tagField = new javax.swing.JTextField();
        removeVehicleTagButton = new javax.swing.JButton();
        ...
        nameButton.setText("Remove By Name");
        ...
        tagButton.setText("Remove By Tag");
        ...
        frontLabel.setText("Select Your Removal Criteria");
        ...
        removeVehicleNameButton.setText("Remove");
        removeVehicleNameButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                removeVehicleNameButtonActionPerformed(evt);
            }
        });
        ...
        namePanelLayout.setHorizontalGroup(
            ...
            .addGroup(namePanelLayout.createSequentialGroup()
                .addGap(348, 348, 348)
                .addComponent(removeVehicleNameButton)
        ...
        removeVehicleTagButton.setText("Remove");
        removeVehicleTagButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                removeVehicleTagButtonActionPerformed(evt);
            }
        });
        ...
        tagPanelLayout.setHorizontalGroup(
            ...
            .addGroup(tagPanelLayout.createSequentialGroup()
                .addGap(348, 348, 348)
                .addComponent(removeVehicleTagButton)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void removeVehicleNameButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeVehicleNameButtonActionPerformed
        ...
        if(nameField.getText().contains(" ") && !nameField.getText().endsWith(" "))
        {
            ...
            if (input == 0)
            {
                vehicle.removeEmployeeByName(nameField.getText());
    ...
    }//GEN-LAST:event_removeVehicleNameButtonActionPerformed
    ...
    private void removeVehicleTagButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeVehicleTagButtonActionPerformed
        if(!tagField.getText().endsWith(" "))
        {
            ...
            int input = JOptionPane.showConfirmDialog(null, "Are these values correct?"
                + "\n\n\n"
                + "Employee: " + tagField.getText()+"\n");

            // 0=yes, 1=no, 2=cancel

            if (input == 0)
            {
                vehicle.removeEmployeeByTag(tagField.getText());
                vehicle.saveVehicles();
    ...
    }//GEN-LAST:event_removeVehicleTagButtonActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vehicleRemove.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vehicleRemove().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton removeVehicleNameButton;
    private javax.swing.JButton removeVehicleTagButton;
